...
from web_admin.models import Imputation
from web_admin.forms import ImputationForm
...
def get_metadata(key = None):
    ...
    data = {
        ...
        'table_title': 'Liste des imputations',
...
def imputation_update(request, pk):
    entity = get_object_or_404(Imputation, pk=pk)
    if request.method == 'POST':
        form = ImputationForm(request.POST, instance=entity)
    else:
        form = ImputationForm(instance=entity)
