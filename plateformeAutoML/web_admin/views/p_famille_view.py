...
from web_admin.forms import FamilleForm
...
def get_metadata(key = None):
    ...
    data = {
        ...
        'table_title': 'Liste des familles du Machine Learning',
        'section_title': 'Parametrage',
        'section_item_title': 'Familles du Machine Learning',
...
def famille_update(request, pk):
    entity = get_object_or_404(Famille, pk=pk)
    if request.method == 'POST':
        form = FamilleForm(request.POST, instance=entity)
    else:
        form = FamilleForm(instance=entity)
