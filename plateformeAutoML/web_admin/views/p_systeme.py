...
def get_metadata(key = None):
    ...
    data = {
        ...
        'table_title': 'Liste des strategie_normalisations du Machine Learning',
...
def initialisation(request):
    #algo, enco, norma, impu, taxonomie_type_donnee, 
...
def strategie_pretraitement_update(request, pk):
