...
from web_admin.models import Package
from web_admin.forms import PackageForm
...
def get_metadata(key = None):
    ...
    data = {
        ...
        'table_title': 'Liste des packages du Machine Learning',
        'section_title': 'Parametrage',
        'section_item_title': 'Packages du Machine Learning',
...
def package_update(request, pk):
    entity = get_object_or_404(Package, pk=pk)
    if request.method == 'POST':
        form = PackageForm(request.POST, instance=entity)
    else:
        form = PackageForm(instance=entity)
